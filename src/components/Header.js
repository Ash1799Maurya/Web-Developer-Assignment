...
<div className='flex-grow flex justify-end'>
          <ul className='flex space-x-8 text-gray-600'>
            ...
            <li>
              <a href="#resource" className='hover:text-gray-900'>Resources</a>
            </li>
            <li>
              <a href="#contact" className='hover:text-gray-900'>Contacts</a>
            </li>
          </ul>
        </div>
        <div className='flex space-x-4 ml-4'>
          <button className="bg-[#767676] text-black px-4 py-2 rounded-md hover:bg-gray-700">
            Sign In
          </button>
          <button className="bg-[#2C2C2C] text-white px-4 py-2 rounded-md hover:bg-gray-800">
            Register
          </button>
        </div>
      </nav>
